...
if(typeof PAGERDUTY_SERVICE_KEY !== 'undefined') {
  var pagerDutyIncidentHandler = new PagerDutyIncidentHandler('https://events.pagerduty.com', 'generic/2010-04-15/create_event.json', _o('env:PAGERDUTY_TOKEN'))
}
...
module.exports = o({
  ...
  post: {
    ...
    service: function(req) {
      /*
        1. If PAGERDUTY_SERVICE_KEY is undefined, return 200
        2. If defined, perform the corresponding action
      */
      console.log("Event received - processing.");
      this.getService().db.getCollection('actions').insert(req.parameters.body)
